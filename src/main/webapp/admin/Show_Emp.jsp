      ...
      <div class="row mt-3 ">
        ...
        <div class="col-md-8">
          <button type="button" id="btn" class="btn btn-primary mb-2">Search</button>
           <button type="button" id="btnall" class="btn btn-primary mb-2">Show All Employee</button>
        </div>
      </div>
    </form>
  </div>
...
<script type="text/javascript" src="../js/employee_show_script.js"></script>
